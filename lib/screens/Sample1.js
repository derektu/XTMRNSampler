    ...
    <View style={styles.stock_row}>
      <View style={styles.stock_row_1}>
        <View style={styles.group_text}>
          <XTMQuoteField symbolId={symbolId} field={XTMField.ID} style={styles.stock_id}/>
          <Text style={styles.stock_id}>(</Text>
          <XTMQuoteField symbolId={symbolId} field={XTMField.Name} style={styles.stock_id}/>
          <Text style={styles.stock_id}>)</Text>
        </View>  
      </View>
      <View style={styles.stock_row_2}>
        <View style={styles.stock_leftblock}>
          <XTMQuoteField symbolId={symbolId} field={XTMField.Close} style={styles.stock_price}/>
          <View style={styles.group_text}>
            <XTMQuoteField symbolId={symbolId} field={XTMField.Change} style={styles.stock_change}/>
            <Text style={styles.stock_change}>(</Text>
            <XTMQuoteField symbolId={symbolId} field={XTMField.ChangeRatio} style={styles.stock_change}/>
            <Text style={styles.stock_change}>)</Text>
          </View>
        </View>
        <View style={styles.stock_rightblock}>
...
const StockRow4TargetFields = (props)=> {
  ...
  return (
    <>
      <View style={styles.group_text}>
        <Text style={styles.stock_target}>目標價:</Text>
        <Text style={[styles.stock_target, targetStyle]}>{target}</Text>
      </View>
      <View style={styles.group_text}>
        <Text style={styles.stock_targetdiff}>價差:</Text>
        <Text style={[styles.stock_target, targetStyle]}>{targetDiffValue}</Text>
      </View>  
    </>
  )
}
